...
import mangasCards from '../redux/actions/mangasCards'
...
function Mangas() {
    ...
    const { pageMangasCards } = mangasCards
        ...
        <>
            <div className="text-white flex items-center w-full min-h-screen">
                ...
                <div className="w-[80%] mt-4">
                    ...
                    <h1 className="text-[1.6rem] mt-16 mb-[4rem]">Search your next manga 🤤</h1>
                    <div className="rounded-[5px] mt-4 mb-8 p-2 flex items-center border-[1px] border-[#ffffff1e] w-[45%] h-11 lg:bg-[#ffffff1e]">
                        ...
                        <input className='text-[17px] text-center text-[#ffffffea] bg-transparent placeholder:text-white placeholder: outline-none text-white lg:text-[18px]' type="text" placeholder="Search" name="title" id="title" ref={title} onKeyUp={() => setReload(!reload)} />
                    </div>
                    <div className="flex flex-wrap gap-7 min-h-[22rem]">
                        {mangas ? mangas.map((eachManga, index) => (
                            <div key={index}>
                                <div onClick={()=> setManga(eachManga)} className="w-[10rem] text-white min-h-[18rem] flex-col flex justify-between">
